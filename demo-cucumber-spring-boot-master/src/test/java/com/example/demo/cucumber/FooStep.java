...
public class FooStep {
    ...
    public void callHello(String name) {
        responseEntity = testRestTemplate.getForEntity("http://localhost:8081/examples/hello?name=" + name, String.class);
    }
    ...
    public void callSum(int a, int b) {
        responseEntity = testRestTemplate.getForEntity("http://localhost:8081/examples/sum?a=" + a +"&b=" + b,
                String.class);
